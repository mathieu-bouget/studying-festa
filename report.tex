...
\[
\begin{pmatrix} S \\ T \end{pmatrix} = \mathbf A\begin{pmatrix} P \\ Q \end{pmatrix} 
\] 
...
\begin{algorithm}
	...
	\KwOut{The isogeny $\varphi$ with the scaling matrix $\mathbf A$ or $\perp$}
\end{algorithm}
...
Pick an arbitrary element $U$ of $\mathrm{ker}(\psi)[d]$ and scale it by $d'$ to get $d'U$,
